...
function init(){
    ...
    mynavbar.innerHTML = mynavbar.innerHTML +
        '<ul>'+
        '<li class="one"><a href="homeDa.html">Hjem</a></li>\n'+
        '<li class="two"><a href="../en/underconstruction.html">Downloads</a></li>\n'+
        '<li class="three"><a href="../en/underconstruction.html">Vores historie</a></li>\n'+
        '<li class="four"><a href="../en/underconstruction.html">Screenshots</a></li>\n'+
        '<li class="five"><a href="../en/underconstruction.html">Lokomotiv liste</a></li>\n'+
        '<li class="six"><a href="../en/underconstruction.html">Personvogns liste</a></li>\n'+
        '<li class="seven"><a href="../en/underconstruction.html">Godsvogns liste</a></li>\n'+
        '</ul>\n' +
        '<style>\n' +
