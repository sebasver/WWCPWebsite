...
function init(){
    ...
    mynavbar.innerHTML = mynavbar.innerHTML +
        '<ul>'+
        '<li class="one"><a href="homeDe.html">Home</a></li>\n'+
        '<li class="two"><a href="../en/underconstruction.html">Downloads</a></li>\n'+
        '<li class="three"><a href="../en/underconstruction.html">Unsere Geschichte</a></li>\n'+
        '<li class="four"><a href="../en/underconstruction.html">Screenshots</a></li>\n'+
        '<li class="five"><a href="../en/underconstruction.html">Unsere Triebfahrzeuge</a></li>\n'+
        '<li class="six"><a href="../en/underconstruction.html">Unsere Personenwagen</a></li>\n'+
        '<li class="seven"><a href="../en/underconstruction.html">Unsere Güterwagen</a></li>\n'+
        '</ul>\n' +
        '<style>\n' +
